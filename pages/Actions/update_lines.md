...
The list of [`Line`]({% link pages/External/line.md %}) objects to add.

`name`

The type of update line action to execute. A full list of line update subactions can be found [here]({% link pages/External/line.md %}).
