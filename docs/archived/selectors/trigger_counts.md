...
The target trigger to retrieve the pressed count of. A full list of available command ids can be found [here]({{ site.baseurl }}{% link docs/external/commands.md %}).
